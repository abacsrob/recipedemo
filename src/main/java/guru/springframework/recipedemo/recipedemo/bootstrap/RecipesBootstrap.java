...
public class RecipesBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private Set<Recipe> initRecipes() {
        Category catChicken = cRepo.findByName("Chicken").get();
        Category catSalad = cRepo.findByName("Salad").get();
        Category catPizza = cRepo.findByName("Pizza").get();
        Category catVegan = cRepo.findByName("Vegan").get();
        UnitOfMeasure uomPound = uRepo.findByName("Pound").get();
        UnitOfMeasure uomOunce = uRepo.findByName("Ounce").get();
        UnitOfMeasure uomPiece = uRepo.findByName("Piece").get();
        UnitOfMeasure uomTeaspoon = uRepo.findByName("Teaspoon").get();
        UnitOfMeasure uomTablespoon = uRepo.findByName("Tablespoon").get();
        ...
        r2.addIngredient(new Ingredient("Pizza dough", BigDecimal.ONE, uomPound))
                .addIngredient(new Ingredient("Olive oil", new BigDecimal("1.5"), uomTablespoon))
                .addIngredient(new Ingredient("Red onion", new BigDecimal("4"), uomPiece))
                .addIngredient(new Ingredient("Fresh ground black pepper", new BigDecimal("2"), uomTeaspoon))
                .addIngredient(new Ingredient("Salt", BigDecimal.ONE, uomTeaspoon))
                .addIngredient(new Ingredient("Chopped broccoli", new BigDecimal("4"), uomPiece))
                .addIngredient(new Ingredient("Black olive", new BigDecimal("0.25"), uomPound))
                .addIngredient(new Ingredient("Flour or cornmeal", new BigDecimal("4"), uomTablespoon))
                .addIngredient(new Ingredient("Tomato sauce", new BigDecimal("5"), uomOunce))
                .addIngredient(new Ingredient("Shredded mozarella cheese", new BigDecimal("8"), uomOunce))
                .addIngredient(new Ingredient("Slivered fresh basil leaves", BigDecimal.ONE, uomOunce));


        r2.addCategory(catPizza)
                .addCategory(catVegan);
